...
public class SteganographyFactory {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SteganographyFactory.getSteganography("example/QuickSorter.java","example/resources/background.png");
        SteganographyFactory.getSteganography("example/SelectSorter.java","example/resources/background.png");
